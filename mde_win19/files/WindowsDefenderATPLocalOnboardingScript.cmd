...
@REM echo.
@REM :USER_CONSENT
@REM set /p shouldContinue= "Press (Y) to confirm and continue or (N) to cancel and exit: "
@REM IF /I "%shouldContinue%"=="N" (
@REM 	GOTO CLEANUP
@REM )
@REM IF /I "%shouldContinue%"=="Y" (
GOTO SCRIPT_START
@REM )
@REM echo.
@REM echo Wrong input. Please try again.
@REM GOTO USER_CONSENT
@REM echo.
:SCRIPT_START
